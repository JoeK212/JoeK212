...
- **[FIGURE GROUND](https://github.com/JoeK212/figuregroundv1)** *(FIGURE / GROUND)* — Three.js figure-ground relief explorer
- **[AUDIO SPECTROGRAM](https://github.com/JoeK212/audiospectrogram)** *(SOUND / RELIEF)* — audio → spectrogram → CNC-millable G-code
- **[TESSERA TILE PATTERN](https://github.com/JoeK212/tesseratilepattern)** *(TESSERA)* — generative tile pattern engine, square and hex grids
